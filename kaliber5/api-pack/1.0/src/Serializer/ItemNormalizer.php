...
final class ItemNormalizer extends AbstractItemNormalizer
{
    ...
    protected function denormalizeRelation(string $attributeName, PropertyMetadata $propertyMetadata, string $className, $value, ?string $format, array $context)
    {
        ...
        try {
            $itemIri = $this->iriConverter->getItemIriFromResourceClass($context['resource_class'], ['id' => $value['id']]);

            return $this->iriConverter->getItemFromIri($itemIri, $context + ['fetch_data' => true]);
